...
import org.apache.hadoop.util.ToolRunner;
 ...
 public class Grep extends Configured
   implements Tool
 {
     ...
     throws Exception
   {
    ...
    Path tempDir = new Path("grep-temp-" + Integer.toString(new Random().nextInt(2147483647)));
 ...
 * Qualified Name:     org.apache.hadoop.examples.Grep
