...
public class PiEstimator extends Configured implements Tool {
	...
	public static BigDecimal estimate(int numMaps, long numPoints, JobConf jobConf) throws IOException {
		...
		try {
			for (int i = 0; i < numMaps; i++) {
				...
				SequenceFile.Writer writer = SequenceFile.createWriter(fs, jobConf, file, LongWritable.class,
			...
			BigDecimal localBigDecimal = BigDecimal.valueOf(4L).setScale(20)
					.multiply(BigDecimal.valueOf(numInside.get())).divide(BigDecimal.valueOf(numMaps))
	...
	public static class PiReducer extends MapReduceBase implements
		...
		public void close() throws IOException {
			...
			SequenceFile.Writer writer = SequenceFile.createWriter(fileSys, this.conf, outFile, LongWritable.class,
					LongWritable.class, SequenceFile.CompressionType.NONE);
	...
	public static class PiMapper extends MapReduceBase implements
		...
		public void map(LongWritable offset, LongWritable size, OutputCollector<BooleanWritable, LongWritable> out,
			...
			System.out.println("-----map-----   offset: "+offset+" size:"+size+" out:"+out+" reporter:");
			PiEstimator.HaltonSequence haltonsequence = new PiEstimator.HaltonSequence(offset.get());
			long numInside = 0L;
			long numOutside = 0L;
 ...
 * org.apache.hadoop.examples.PiEstimator JD-Core Version: 0.6.0
 */